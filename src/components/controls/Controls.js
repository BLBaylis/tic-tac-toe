...
const Controls = (props) => {
    return (
        <div className = {styles.controls}>
          <Button noLeftMargin
          onClick={() => props.onClickObj.restart(props.argsFromState.firstMove, props.argsFromState.gridSize)}
        >Restart
        </Button>
        <Button onClick={props.onClickObj.undo}>
        Undo
        </Button>
        <Button onClick={props.onClickObj.redo}>
        Redo
        </Button>
        <Button
          onClick={() =>
